...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/usr/local --enable-gpl --enable-nonfree --enable-libass --enable-libfdk-aac --enable-libfreetype --enable-libmp3lame --enable-libtheora --enable-libvorbis --enable-libvpx --enable-libx264 --enable-libx265 --enable-libopus --enable-libxvid --samples=fate-suite/
prefix=/usr/local
...
CFLAGS=   -std=c11 -Werror=partial-availability -fomit-frame-pointer -fPIC -pthread -I/usr/local/Cellar/libass/0.14.0_1/include -I/usr/local/Cellar/harfbuzz/1.8.8/include/harfbuzz -I/usr/local/Cellar/glib/2.56.2/include/glib-2.0 -I/usr/local/Cellar/glib/2.56.2/lib/glib-2.0/include -I/usr/local/opt/gettext/include -I/usr/local/Cellar/pcre/8.42/include -I/usr/local/Cellar/graphite2/1.3.12/include -I/usr/local/Cellar/fribidi/1.0.5/include/fribidi -I/usr/local/opt/freetype/include/freetype2 -I/usr/local/Cellar/fdk-aac/0.1.6/include -I/usr/local/opt/freetype/include/freetype2 -I/usr/local/Cellar/opus/1.2.1/include/opus -I/usr/local/Cellar/opus/1.2.1/include/opus -I/usr/local/Cellar/libvorbis/1.3.6/include -I/usr/local/Cellar/libogg/1.3.3/include -I/usr/local/Cellar/libvorbis/1.3.6/include -I/usr/local/Cellar/libogg/1.3.3/include -I/usr/local/Cellar/libvpx/1.7.0/include -I/usr/local/Cellar/libvpx/1.7.0/include -I/usr/local/Cellar/libvpx/1.7.0/include -I/usr/local/Cellar/libvpx/1.7.0/include -I/usr/local/Cellar/x264/r2854/include -I/usr/local/Cellar/x265/2.8/include -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -D_THREAD_SAFE -I/usr/local/include/SDL2
...
EXTRALIBS-avfilter=-framework OpenGL -framework OpenGL -pthread -lm -L/usr/local/Cellar/libass/0.14.0_1/lib -lass -framework CoreImage -framework AppKit -L/usr/local/opt/freetype/lib -lfreetype
