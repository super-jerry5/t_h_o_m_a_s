...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/data/barryhe/code/t_h_o_m_a_s/ffmpeg/ffmpeg_build/ --enable-gpl --enable-nonfree --enable-libass --enable-libfdk-aac --enable-libfreetype --enable-libmp3lame --enable-libx264 --enable-libx265 --enable-cuda --enable-cuvid --enable-nvenc --enable-nonfree --enable-libnpp --disable-shared --enable-static --extra-cflags=-I/usr/local/cuda/include --extra-ldflags=-L/usr/local/cuda/lib64
...
CFLAGS=  -I/usr/local/cuda/include -std=c11 -fomit-frame-pointer -I/usr/local/include -pthread -I/usr/include/harfbuzz -I/usr/include/freetype2 -I/usr/include/fribidi -I/usr/include/freetype2 -I/usr/local/include -I/usr/include/freetype2 -I/usr/local/include      -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -I/usr/local/cuda/include -g
...
DEPWINDRES=gcc
DOXYGEN=doxygen
LDFLAGS= -L/usr/local/cuda/lib64  -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS-avcodec=-pthread -lm -llzma -lz -L/usr/local/lib -lfdk-aac -lmp3lame -lm -L/usr/local/lib -lx264 -lx265 -lva -ldl
EXTRALIBS-avdevice=-lm -lxcb -lxcb-shm -lxcb -lxcb-shape -lxcb -lxcb-xfixes -lxcb-render -lxcb-shape -lxcb
EXTRALIBS-avfilter=-pthread -lm -lnppig -lnppicc -lnppc -lva -lass -lfreetype -ldl
EXTRALIBS-avformat=-lm -lz
EXTRALIBS-avresample=-lm
EXTRALIBS-avutil=-pthread -lva -lva-drm -lva -lva-x11 -lX11 -lvdpau -lX11 -lm -lva -ldl
